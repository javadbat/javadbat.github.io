        ...
        <section className={styles.introWrapper}>
            <div className={styles.introContent}>
                <h1 className={styles.pageTitle}>
                    <span className={styles.name}>Seyed Mohammad Javad</span>
                    <span className={styles.family}>Bathaei</span>
                </h1>
                <h2 className={styles.subtitle}>Creative Front-end Web Developer</h2>
                <CTAButton>Contact Me</CTAButton>
            </div>
            <div className={styles.mouseIconWrapper}>

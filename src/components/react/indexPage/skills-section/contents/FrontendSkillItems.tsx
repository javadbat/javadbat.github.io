  ...
  return (
    <div className={styles.skillContent}>
      ...
      <p className={`${styles.skillParagraph} ${styles.indent}`}>
        My main stack is around <b>React, TypeScript, MobX, Zustand, React Query, Web Components, MUI, GraphQL, WebSocket, Vite, Webpack, Rollup, Tailwind CSS, ShadCN,</b> and{" "}
        <b>Storybook</b>. I have used these tools to build real product interfaces, not only static pages, but applications with complex flows, authentication, forms, tables,
        charts, maps, live data, and reusable UI architecture.
      </p>
      ...
      <p className={`${styles.skillParagraph}`}>
        I enjoy front-end work because it combines logic, visual thinking, product understanding, and user experience. For me, a strong front-end is not only about making an
        interface look good, but about building a system that is clear for users, maintainable for developers, and flexible enough to grow with the product.
      </p>
    </div>
  );
}

  ...
  return (
    <div className={styles.skillContent}>
      ...
      <p className={`${styles.skillParagraph} ${styles.indent}`}>
        his mindset is especially important in admin panels and dashboards, where users usually work with data, actions, forms, and daily workflows. A small design or development
        decision can make the product easier, faster, and more comfortable to use.
      </p>
      ...
      <p className={`${styles.skillParagraph}`}>
        For me, good software is not only about building what was requested, but about helping the team build what is actually useful. I enjoy being part of this process and
        contributing as a developer who cares about both the product and the people who use it.
      </p>
    </div>
  );
}

...
function BackendSkillItems() {
  return (
    <div className={styles.skillContent}>
      ...
      <p className={`${styles.skillParagraph}`}>Before becoming fully focused on front-end development, I worked for several years with <b>C#/.NET and SQL Server</b>. That experience gave me a solid understanding of backend logic, database structure, APIs, and how software works behind the interface.</p>
      ...
      <p className={`${styles.skillParagraph}`}>Recently, I have also gained experience with modern backend tools and frameworks such as <b>Node.js, NestJS, Strapi, Ghost, and Rust with Actix Web and PostgreSQL</b>. These projects helped me refresh and expand my backend knowledge while working with different types of backend structures, from CMS-based solutions to custom APIs and database-driven services.</p>

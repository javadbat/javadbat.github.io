    ...
    <div className={styles.skillContent}>
      <div>
        ...
        <p className={`${styles.skillParagraph} ${styles.indent}`}>
          Over time, I’ve designed more than 20 dashboards, websites, and PWA applications on my own, turning product ideas and requirements into practical, user-friendly
          interfaces.
        </p>
        <p className={`${styles.skillParagraph}`}>My experience includes:</p>
        ...
        <p className={`${styles.skillParagraph}`}>
          Although UI/UX is not my main profession, it strongly supports the way I work as a front-end developer. I believe good interfaces are not only about clean code or
          attractive visuals, but about creating experiences that feel clear, useful, and easy to use.
        </p>
      </div>
    </div>
  );

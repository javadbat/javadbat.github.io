  ...
  return (
    <div className={styles.skillContent}>
      ...
      <p className={`${styles.skillParagraph} ${styles.indent}`}>
        After that, I spent almost five years mainly focused on front-end development, but my backend background has continued to help me in everyday product work.
      </p>
      ...
      <p className={`${styles.skillParagraph}`}>
        Recently, I have also gained experience with modern backend tools and frameworks such as <b>Node.js, NestJS, Strapi, Ghost, and Rust with Actix Web and PostgreSQL</b>.
      ...
      <p className={`${styles.skillParagraph} ${styles.indent}`}>
        Although my main professional focus is front-end, I enjoy working on small to mid-sized backend services, especially when they are connected to real product needs. I’m also
        interested in contributing to larger backend systems as part of a strong team, where an experienced tech lead or supervisor can guide the architecture and help me grow
        deeper in backend development.
      </p>
      <p className={`${styles.skillParagraph} ${styles.indent}`}>
        This backend foundation gives me stronger full-stack awareness and helps me contribute better inside product and development teams.
      </p>
    </div>
  );
}

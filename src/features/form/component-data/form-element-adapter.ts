...
import { getLocalizedText, type JBFormElementKind, type JBFormElementType, type JBFormElementV1, type JSONPrimitive, type JSONValue, type LocalizedText } from "jb-form-builder/contract";
import type { FormIssue } from "jb-form-builder/contract";
import type { CommonFieldSupport, FormElementPropertyDefinition, InitialValueKind } from "./form-element-configuration";
import { compileValidationRule, validatePortableValidationRule, type ValidationRuleName } from "jb-form-builder/registry/validation-rule-registry";
...
import { adapterData as textAdapterData } from "./text/adapter";
import { adapterData as imageAdapterData } from "./image/adapter";
import { adapterData as voiceAdapterData } from "./voice/adapter";
import { adapterData as linkAdapterData } from "./link/adapter";
import { adapterData as dividerAdapterData } from "./divider/adapter";
import { adapterData as sectionHeadingAdapterData } from "./section-heading/adapter";
import { adapterData as inputAdapterData } from "./jb-input/adapter";
import { adapterData as numberInputAdapterData } from "./jb-number-input/adapter";
import { adapterData as rangeInputAdapterData } from "./jb-range-input/adapter";
import { adapterData as mobileInputAdapterData } from "./jb-mobile-input/adapter";
import { adapterData as passwordInputAdapterData } from "./jb-password-input/adapter";
import { adapterData as paymentInputAdapterData } from "./jb-payment-input/adapter";
import { adapterData as nationalInputAdapterData } from "./jb-national-input/adapter";
import { adapterData as dateInputAdapterData } from "./jb-date-input/adapter";
import { adapterData as timeInputAdapterData } from "./jb-time-input/adapter";
import { adapterData as pinInputAdapterData } from "./jb-pin-input/adapter";
import { adapterData as textareaAdapterData } from "./jb-textarea/adapter";
import { adapterData as selectAdapterData } from "./jb-select/adapter";
import { adapterData as listboxAdapterData } from "./jb-listbox/adapter";
import { adapterData as checkboxAdapterData } from "./jb-checkbox/adapter";
import { adapterData as switchAdapterData } from "./jb-switch/adapter";
import { adapterData as fileInputAdapterData } from "./jb-file-input/adapter";
import { adapterData as imageInputAdapterData } from "./jb-image-input/adapter";
import { adapterData as buttonAdapterData } from "./jb-button/adapter";
import { adapterData as tabAdapterData } from "./jb-tab/adapter";
import { adapterData as conditionAdapterData } from "./jb-condition/adapter";
import { adapterData as formWizardAdapterData } from "./jb-form-wizard/adapter";
import { adapterData as repeatableGroupAdapterData } from "./jb-repeatable-group/adapter";
...
const definitions = [
  ...
  linkAdapterData,
  dividerAdapterData,
  sectionHeadingAdapterData,
  inputAdapterData,
  numberInputAdapterData,
  rangeInputAdapterData,
  mobileInputAdapterData,
  passwordInputAdapterData,
  paymentInputAdapterData,
  nationalInputAdapterData,
  dateInputAdapterData,
  timeInputAdapterData,
  pinInputAdapterData,
  textareaAdapterData,
  selectAdapterData,
  listboxAdapterData,
  checkboxAdapterData,
  switchAdapterData,
  fileInputAdapterData,
  imageInputAdapterData,
  buttonAdapterData,
  tabAdapterData,
  conditionAdapterData,
  formWizardAdapterData,
  repeatableGroupAdapterData,
